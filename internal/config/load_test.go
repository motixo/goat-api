...
func TestLoadParsesCompleteTypedConfiguration(t *testing.T) {
	...
	setEnvironmentValues(t, map[string]string{
		...
		"RATE_LIMIT_PROTECTED_IP_LIMIT":  "500",
		"RATE_LIMIT_PROTECTED_IP_WINDOW": "5m",
	...
	want := &Config{
		...
		RateLimitProtectedIPLimit:  500,
		RateLimitProtectedIPWindow: 5 * time.Minute,
...
func TestLoadAppliesIntentionalDefaults(t *testing.T) {
	...
	for name, values := range map[string]struct {
		...
		"RATE_LIMIT_PROTECTED_IP_WINDOW": {got: cfg.RateLimitProtectedIPWindow, want: time.Minute},
	...
	if cfg.RateLimitAuthLimit != 5 ||
		...
		cfg.RateLimitProtectedIPLimit != 300 ||
...
func TestLoadRejectsInvalidRanges(t *testing.T) {
	tests := []struct {
		...
		{name: "RATE_LIMIT_PROTECTED_IP_LIMIT", value: "0", wantFragment: "RATE_LIMIT_PROTECTED_IP_LIMIT"},
		{name: "RATE_LIMIT_PROTECTED_IP_WINDOW", value: "-1s", wantFragment: "RATE_LIMIT_PROTECTED_IP_WINDOW"},
